...
# ️️️️️✈️ 核心AI服务配置
# ========================
OPENAI_API_KEY="your_api_key_here"  # 建议创建专用航空领域API Key
OPENAI_BASE_URL=""  # 企业部署可替换为内网地址

# ========================
# ️️️️️🏭 制造知识图谱连接
# ========================
NEO4J_URI="bolt://localhost:7687"       # 生产环境建议使用neo4j://cluster.prod:7687
NEO4J_USERNAME="aerospace_engineer"     # 最小权限账户
NEO4J_PASSWORD=""
```
